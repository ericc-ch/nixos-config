...
Report what you saved: each skill patched, each support file added, and each skipped signal with a reason. Save every accepted lesson to a file before you stop.
