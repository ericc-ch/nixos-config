...
**The baseline is the spec; you do not touch it.** For "make X match Y exactly", styling-system migrations, porting a UI across frameworks or themes. Equivalence is verified by image diff, not by eye.
