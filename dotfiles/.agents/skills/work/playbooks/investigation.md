...
**Read-only questions:** "how does X work", "why was Y built this way", "are we sure about Z", "should we do X or Y". Output is a cited explanation or a recommendation, not a code change.
