...
**The structure changes; the behavior does not.** For "refactor", "rename", "extract", "dedupe", "move this module", "tidy this area". Behavior changes go to feature. A refactor that smuggles in behavior loses its safety net.
