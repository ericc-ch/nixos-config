...
- **Reusability & Utility:** The amount of functionality an interface provides relative to its simplicity. A well-designed interface provides high utility with minimal surface area.
